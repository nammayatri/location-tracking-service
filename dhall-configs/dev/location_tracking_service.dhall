...
in {
    ...
    bulk_location_pickup_callback_url = "http://127.0.0.1:8016/internal/bulkLocPickupUpdate",
    ...
    driver_nearby_debug_topic = Some "driver_nearby_debug",
    ...
    pickup_instruction_notification_threshold = 500.0,
