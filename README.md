...
1. Install **home-manager**[^hm] and setup **nix-direnv** and **starship** by following the instructions [in this home-manager template](https://github.com/juspay/nixos-unified-template).[^direnv] [You want this](https://nixos.asia/en/direnv) to facilitate a nice Nix develoment environment.
